...
void Camera::RotateUAround(double angle,const Point& center,double distance) {
    RotateU(angle);
    eye=center-distance*look;
}
...
void Camera::RotateAround(Point p, Vector axis, double angle,const Point& center,double distance){
    Rotate(p,axis,angle);
    eye=center-distance*look;
}
